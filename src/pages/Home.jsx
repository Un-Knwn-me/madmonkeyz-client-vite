...
import { manageWishlist } from "../features/user/userSlice.jsx";
...
const Home = () => {
  ...
  return (
    <>
        ...
        <div className="absolute mx-10 md:mx-80 -bottom-10 left-0 right-0 text-center bg-teal-100 border-t border-cyan-400">
          <div className="w-1/2 mx-auto py-2 md:py-7">
            <p className="text-lg">
              ...
              <span className="text-amber-500 font-bold"> Only </span> For You
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="columns-2 flex m-10 md:my-20 md:mx-30">
        <div className="w-full relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <p className="text-white text-5xl font-times-new-roman tracking-wider leading-10 text-center font-medium">
              FLAT <span className="text-3xl align-top">₹</span>50 OFF
            </p>
          </div>
        </div>
        <div className="w-full relative">
          ...
          />
          <div className="absolute inset-0 flex items-center justify-center">
            <p className="text-white text-2xl leading-10 tracking-wide text-center font-light mx-5">
              On your first purchase above ₹2000
            </p>
          </div>
        </div>
      </div>

      <div className="my-10 text-lg font-medium text-center font-red-hat-display">
        SPECIAL ARRIVALS FOR YOU
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 m-10 md:my-20 md:mx-30">
          {homeProducts.map((product, key) => (
            <Link to={`/category/${product._id}`} key={product._id}>
              <div className="z-10 w-full md:w-64 h-96 relative rounded shadow border border-neutral-200">
      ...
      {/* Coupons */}
      <div className="mt-30 mb-20 text-2xl font-medium text-blue-800 text-center font-times-new-roman">
        COUPON ZONE
      </div>
        ...
        <div className="w-fit relative mx-20">
          ...
          <div className="absolute inset-0 columns-2 flex items-center justify-center">
            <div className="text-center mx-5">
              <p className="text-white text-2xl font-times-new-roman tracking-wide leading-10 font-medium">
                UPTO 50% OFF
              </p>
              <p className="text-white text-lg font-red-hat-display leading-tight tracking-tight font-normal">
                On All Products
              </p>
            </div>
            <div className="px-4 py-2 bg-white">
              <p className="text-center text-black text-sm py-2 font-semibold font-red-hat-display leading-tight tracking-tight">
                USE CODE
              </p>
              <p className="text-center text-white bg-black py-2 px-3 text-xs font-bold font-red-hat-display leading-tight tracking-tight">
                EMPOLO50
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-10 m-10 md:my-20 md:mx-30">
        <div className="w-60 h-80 relative shadow border-8 border-green-600 bg-green-600">
          ...
          <div className="my-3">
            <p className="text-center text-white text-sm font-light font-red-hat-display leading-tight tracking-tight my-1">
              Mens Casual Wear
            </p>
            <p className="text-center text-white text-xl font-bold font-times-new-roman leading-tight tracking-wide">
              20 - 30% OFF
            </p>
          </div>
          <div className="text-center text-white text-sm font-semibold font-red-hat-display leading-tight tracking-tight mt-4">
            Shop Now
          </div>
        </div>
