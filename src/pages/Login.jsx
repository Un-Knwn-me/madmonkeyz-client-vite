...
import { loggedIn } from "../features/user/userSlice.jsx";

const Login = () => {
  const [showPassword, setShowPassword] = useState(false);
  const [user, setUser] = useState({userVerify: '', password: ''});
  ...
  return (
    <>
      <div className="grid grid-cols-12 gap-6 md:gap-0 h-screen bg-gray-100">
        ...
        <div className="col-span-12 md:col-span-5 flex flex-col justify-center items-center p-8">
          <Card color="transparent" shadow={false}>
            <Typography variant="h4" color="blue-gray">
              Sign In
            </Typography>
            <Typography color="gray" className="mt-1 font-normal">
              Nice to meet you! Enter your details to explore.
            </Typography>
            <form
            ...
            >
              <div className="mb-1 flex flex-col gap-6">
                ...
                <Input
                  ...
                  id="userVerify"
                  name="userVerify"
                  autoComplete="userVerify"
                  value={user.userVerify}
                  onChange={handleInputChange}
                  size="lg"
                  placeholder="name@mail.com/+91 00000 00000"
